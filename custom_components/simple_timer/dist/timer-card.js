          ...
          >
            ...
            `)}
				...
				<div class="config-row">
					...
					>
						${(null===(o=this._config)||void 0===o?void 0:o.power_button_icon)?V`
				...
				<div class="config-row">
					<ha-formfield .label=${"Reverse Mode (Delayed Start)"}>
						<ha-switch
							.checked=${(null===(r=this._config)||void 0===r?void 0:r.reverse_mode)||!1}
