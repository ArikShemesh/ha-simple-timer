 ...
 */class st extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const o=i?.renderBefore??e;let n=o._$litPart$;if(void 0===n){const t=i?.renderBefore??null;o._$litPart$=n=new Z(e.insertBefore(P(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return z}}st._$litElement$=!0,st.finalized=!0,nt.litElementHydrateSupport?.({LitElement:st});const rt=nt.litElementPolyfillSupport;rt?.({LitElement:st}),(nt.litElementVersions??=[]).push("4.2.0");const at=s`
  ...
  `,lt="simple_timer",ct=[15,30,60,90,120,150];console.info("%c SIMPLE-TIMER-CARD %c v1.3.40 ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");customElements.define("timer-card",class extends st{constructor(){super(...arguments),this._countdownInterval=null,this._liveRuntimeSeconds=0,this._timeRemaining=null,this._sliderValue=0,this.buttons=[],this._validationMessages=[],this._notificationSentForCurrentCycle=!1,this._entitiesLoaded=!1,this._effectiveSwitchEntity=null,this._effectiveSensorEntity=null,this._longPressTimer=null,this._isLongPress=!1,this._touchStartPosition=null,this._isCancelling=!1}static get properties(){return{hass:{type:Object},_config:{type:Object},_timeRemaining:{state:!0},_sliderValue:{state:!0},_entitiesLoaded:{state:!0},_effectiveSwitchEntity:{state:!0},_effectiveSensorEntity:{state:!0},_validationMessages:{state:!0}}}static async getConfigElement(){return await Promise.resolve().then(function(){return gt}),document.createElement("timer-card-editor")}static getStubConfig(t){return console.log("TimerCard: Generating stub config - NO auto-selection will be performed"),{type:"custom:timer-card",timer_instance_id:null,timer_buttons:[...ct],card_title:"Simple Timer",power_button_icon:"mdi:power",hide_slider:!1,slider_thumb_color:null,slider_background_color:null,power_button_background_color:null,power_button_icon_color:null}}setConfig(t){const e=t.slider_max&&t.slider_max>0&&t.slider_max<=1e3?t.slider_max:120,i=t.timer_instance_id||"default";this.buttons=this._getValidatedTimerButtons(t.timer_buttons),this._config={type:t.type||"custom:timer-card",timer_buttons:t.timer_buttons||[...ct],card_title:t.card_title||null,power_button_icon:t.power_button_icon||null,slider_max:e,slider_unit:t.slider_unit||"min",reverse_mode:t.reverse_mode||!1,hide_slider:t.hide_slider||!1,show_daily_usage:!1!==t.show_daily_usage,timer_instance_id:i,entity:t.entity,sensor_entity:t.sensor_entity,slider_thumb_color:t.slider_thumb_color||null,slider_background_color:t.slider_background_color||null,timer_button_font_color:t.timer_button_font_color||null,timer_button_background_color:t.timer_button_background_color||null,power_button_background_color:t.power_button_background_color||null,power_button_icon_color:t.power_button_icon_color||null},t.timer_instance_id&&(this._config.timer_instance_id=t.timer_instance_id),t.entity&&(this._config.entity=t.entity),t.sensor_entity&&(this._config.sensor_entity=t.sensor_entity);const o=localStorage.getItem(`simple-timer-slider-${i}`);let n=o?parseInt(o):NaN;(isNaN(n)||n<=0)&&(n=e),n>e&&(n=e),this._sliderValue=n,localStorage.setItem(`simple-timer-slider-${i}`,this._sliderValue.toString()),this.requestUpdate(),this._liveRuntimeSeconds=0,this._notificationSentForCurrentCycle=!1,this._effectiveSwitchEntity=null,this._effectiveSensorEntity=null,this._entitiesLoaded=!1}_getValidatedTimerButtons(t){let e=[];if(this._validationMessages=[],Array.isArray(t)){const i=[],o=new Set,n=[];t.forEach(t=>{let s,r,a="min",l="Min";const c=String(t).trim().toLowerCase().match(/^(\d+(?:\.\d+)?)\s*(s|sec|seconds|m|min|minutes|h|hr|hours)?$/);if(c){const d=parseFloat(c[1]),h=c[1].includes("."),u=c[2]||"min",_=u.startsWith("h");if(h&&!_)return void i.push(t);if(s=d,u.startsWith("s")?(a="s",l="sec",r=s/60):u.startsWith("h")?(a="h",l="hr",r=60*s):(a="min",l="min",r=s),s>0){const i=`${r}`;o.has(i)?n.push(t):(o.add(i),e.push({displayValue:s,unit:a,labelUnit:l,minutesEquivalent:r}))}else i.push(t)}else i.push(t)});const s=[];return i.length>0&&s.push(`Invalid timer values ignored: ${i.join(", ")}. Format example: 30, "30s", "1h".`),n.length>0&&s.push("Duplicate timer values were removed."),this._validationMessages=s,e.sort((t,e)=>t.minutesEquivalent-e.minutesEquivalent),e}return null==t||(console.warn(`TimerCard: Invalid timer_buttons type (${typeof t}):`,t,"- using empty array"),this._validationMessages=[`Invalid timer_buttons configuration. Expected array, got ${typeof t}.`]),[]}_determineEffectiveEntities(){var t,e;let i=null,o=null,n=!1;if(this.hass&&this.hass.states){if(null===(t=this._config)||void 0===t?void 0:t.timer_instance_id){const t=this._config.timer_instance_id,e=Object.keys(this.hass.states).filter(t=>t.startsWith("sensor.")).find(e=>{const i=this.hass.states[e];return i.attributes.entry_id===t&&"string"==typeof i.attributes.switch_entity_id});if(e){o=e,i=this.hass.states[e].attributes.switch_entity_id,i&&this.hass.states[i]?n=!0:console.warn(`TimerCard: Configured instance '${t}' sensor '${o}' links to missing or invalid switch '${i}'.`)}else console.warn(`TimerCard: Configured timer_instance_id '${t}' does not have a corresponding simple_timer sensor found.`)}if(!n&&(null===(e=this._config)||void 0===e?void 0:e.sensor_entity)){const t=this.hass.states[this._config.sensor_entity];t&&"string"==typeof t.attributes.entry_id&&"string"==typeof t.attributes.switch_entity_id?(o=this._config.sensor_entity,i=t.attributes.switch_entity_id,i&&this.hass.states[i]?(n=!0,console.info(`TimerCard: Using manually configured sensor_entity: Sensor '${o}', Switch '${i}'.`)):console.warn(`TimerCard: Manually configured sensor '${o}' links to missing or invalid switch '${i}'.`)):console.warn(`TimerCard: Manually configured sensor_entity '${this._config.sensor_entity}' not found or missing required attributes.`)}this._effectiveSwitchEntity===i&&this._effectiveSensorEntity===o||(this._effectiveSwitchEntity=i,this._effectiveSensorEntity=o,this.requestUpdate()),this._entitiesLoaded=n}else this._entitiesLoaded=!1}_getEntryId(){if(!this._effectiveSensorEntity||!this.hass||!this.hass.states)return console.error("Timer-card: _getEntryId called without a valid effective sensor entity."),null;const t=this.hass.states[this._effectiveSensorEntity];return t&&t.attributes.entry_id?t.attributes.entry_id:(console.error("Could not determine entry_id from effective sensor_entity attributes:",this._effectiveSensorEntity),null)}_startTimer(t,e="min",i="button"){var o;if(this._validationMessages=[],!this._entitiesLoaded||!this.hass||!this.hass.callService)return void console.error("Timer-card: Cannot start timer. Entities not loaded or callService unavailable.");const n=this._getEntryId();if(!n)return void console.error("Timer-card: Entry ID not found for starting timer.");const s=this._effectiveSwitchEntity;(null===(o=this._config)||void 0===o?void 0:o.reverse_mode)||!1?this.hass.callService("homeassistant","turn_off",{entity_id:s}).then(()=>{this.hass.callService(lt,"start_timer",{entry_id:n,duration:t,unit:e,reverse_mode:!0,start_method:i})}).catch(t=>{console.error("Timer-card: Error turning off switch for reverse timer:",t)}):this.hass.callService("homeassistant","turn_on",{entity_id:s}).then(()=>{this.hass.callService(lt,"start_timer",{entry_id:n,duration:t,unit:e,start_method:i})}).catch(t=>{console.error("Timer-card: Error turning on switch or starting timer:",t)}),this._notificationSentForCurrentCycle=!1}_cancelTimer(){if(this._validationMessages=[],!this._entitiesLoaded||!this.hass||!this.hass.callService)return void console.error("Timer-card: Cannot cancel timer. Entities not loaded or callService unavailable.");this._isCancelling=!0;const t=this._getEntryId();if(!t)return console.error("Timer-card: Entry ID not found for cancelling timer."),void(this._isCancelling=!1);this.hass.callService(lt,"cancel_timer",{entry_id:t}).then(()=>{setTimeout(()=>{this._isCancelling=!1},1e3)}).catch(t=>{console.error("Timer-card: Error cancelling timer:",t),this._isCancelling=!1}),this._notificationSentForCurrentCycle=!1}_togglePower(){var t,e;if(this._validationMessages=[],!(this._entitiesLoaded&&this.hass&&this.hass.states&&this.hass.callService))return void console.error("Timer-card: Cannot toggle power. Entities not loaded or services unavailable.");if(this._isCancelling)return;const i=this._effectiveSwitchEntity,o=this._effectiveSensorEntity,n=this.hass.states[i];if(!n)return void console.warn(`Timer-card: Switch entity '${i}' not found during toggle.`);const s=this.hass.states[o];if(s&&"active"===s.attributes.timer_state){return void(s.attributes.reverse_mode?(this._cancelTimer(),console.log(`Timer-card: Cancelling reverse timer and turning on switch: ${i}`)):(this._cancelTimer(),console.log(`Timer-card: Cancelling normal timer for switch: ${i}`)))}if("on"===n.state)this.hass.callService(lt,"manual_power_toggle",{entry_id:this._getEntryId(),action:"turn_off"}),console.log(`Timer-card: Manually turning off switch: ${i}`);else{if(null===(t=this._config)||void 0===t?void 0:t.hide_slider)this.hass.callService(lt,"manual_power_toggle",{entry_id:this._getEntryId(),action:"turn_on"}).then(()=>{console.log(`Timer-card: Manually turning on switch (infinite, hidden slider): ${i}`)}).catch(t=>{console.error("Timer-card: Error manually turning on switch:",t)});else if(this._sliderValue>0){const t=(null===(e=this._config)||void 0===e?void 0:e.slider_unit)||"min";this._startTimer(this._sliderValue,t,"slider"),console.log(`Timer-card: Starting timer for ${this._sliderValue} ${t}`)}else this.hass.callService(lt,"manual_power_toggle",{entry_id:this._getEntryId(),action:"turn_on"}).then(()=>{console.log(`Timer-card: Manually turning on switch (infinite): ${i}`)}).catch(t=>{console.error("Timer-card: Error manually turning on switch:",t)});this._notificationSentForCurrentCycle=!1}}_showMoreInfo(){if(!this._entitiesLoaded||!this.hass)return void console.error("Timer-card: Cannot show more info. Entities not loaded.");const t=this._effectiveSensorEntity,e=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}});this.dispatchEvent(e)}connectedCallback(){var t,e;super.connectedCallback();const i=(null===(t=this._config)||void 0===t?void 0:t.timer_instance_id)||"default";if(localStorage.getItem(`simple-timer-slider-${i}`));else if(this._determineEffectiveEntities(),this._entitiesLoaded&&this.hass&&this._effectiveSensorEntity){const t=this.hass.states[this._effectiveSensorEntity],i=(null===(e=null==t?void 0:t.attributes)||void 0===e?void 0:e.timer_duration)||0;i>0&&i<=120&&(this._sliderValue=i)}this._determineEffectiveEntities(),this._updateLiveRuntime(),this._updateCountdown()}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown(),this._stopLiveRuntime(),this._longPressTimer&&window.clearTimeout(this._longPressTimer)}updated(t){(t.has("hass")||t.has("_config"))&&(this._determineEffectiveEntities(),this._updateLiveRuntime(),this._updateCountdown())}_updateLiveRuntime(){this._liveRuntimeSeconds=0}_stopLiveRuntime(){this._liveRuntimeSeconds=0}_updateCountdown(){if(!this._entitiesLoaded||!this.hass||!this.hass.states)return void this._stopCountdown();const t=this.hass.states[this._effectiveSensorEntity];if(!t||"active"!==t.attributes.timer_state)return this._stopCountdown(),void(this._notificationSentForCurrentCycle=!1);if(!this._countdownInterval){const e=t.attributes.timer_finishes_at;if(void 0===e)return console.warn("Timer-card: timer_finishes_at is undefined for active timer. Stopping countdown."),void this._stopCountdown();const i=new Date(e).getTime(),o=()=>{const t=(new Date).getTime(),e=Math.max(0,Math.round((i-t)/1e3));if(this._getShowSeconds()){const t=Math.floor(e/3600),i=Math.floor(e%3600/60),o=e%60;this._timeRemaining=`${t.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}`}else{const t=Math.floor(e/60),i=e%60;this._timeRemaining=`${t.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}`}0===e&&(this._stopCountdown(),this._notificationSentForCurrentCycle||(this._notificationSentForCurrentCycle=!0))};this._countdownInterval=window.setInterval(o,500),o()}}_stopCountdown(){this._countdownInterval&&(window.clearInterval(this._countdownInterval),this._countdownInterval=null),this._timeRemaining=null}_hasOrphanedTimer(){var t,e;if(!this._entitiesLoaded||!this.hass||!this._effectiveSensorEntity)return{isOrphaned:!1};const i=this.hass.states[this._effectiveSensorEntity];if(!i||"active"!==i.attributes.timer_state)return{isOrphaned:!1};const o=i.attributes.timer_duration||0;if("slider"===i.attributes.timer_start_method)return{isOrphaned:!1};const n=this.buttons.some(t=>Math.abs(t.minutesEquivalent-o)<.001);let s=(null===(t=this._config)||void 0===t?void 0:t.slider_max)||120;const r=(null===(e=this._config)||void 0===e?void 0:e.slider_unit)||"min";"h"===r||"hr"===r||"hours"===r?s*=60:"s"!==r&&"sec"!==r&&"seconds"!==r||(s/=60);return{isOrphaned:!n&&!(o>=0&&o<=s+.001),duration:o}}_getShowSeconds(){var t;if(!this._entitiesLoaded||!this.hass||!this._effectiveSensorEntity)return!1;const e=this.hass.states[this._effectiveSensorEntity];return(null===(t=null==e?void 0:e.attributes)||void 0===t?void 0:t.show_seconds)||!1}_handleUsageClick(t){t.preventDefault(),this._isLongPress||this._showMoreInfo(),this._isLongPress=!1}_startLongPress(t){t.preventDefault(),this._isLongPress=!1,this._longPressTimer=window.setTimeout(()=>{this._isLongPress=!0,this._resetUsage(),"vibrate"in navigator&&navigator.vibrate(50)},800)}_endLongPress(t){t&&t.preventDefault(),this._longPressTimer&&(window.clearTimeout(this._longPressTimer),this._longPressTimer=null)}_handlePowerClick(t){"click"!==t.type||this._isLongPress||(t.preventDefault(),t.stopPropagation(),this._togglePower()),this._isLongPress=!1}_handleTouchEnd(t){t.preventDefault(),t.stopPropagation(),this._longPressTimer&&(window.clearTimeout(this._longPressTimer),this._longPressTimer=null);let e=!1;if(this._touchStartPosition&&t.changedTouches[0]){const i=t.changedTouches[0],o=Math.abs(i.clientX-this._touchStartPosition.x),n=Math.abs(i.clientY-this._touchStartPosition.y),s=10;e=o>s||n>s}this._isLongPress||e||this._showMoreInfo(),this._isLongPress=!1,this._touchStartPosition=null}_handleTouchStart(t){t.preventDefault(),t.stopPropagation(),this._isLongPress=!1;const e=t.touches[0];this._touchStartPosition={x:e.clientX,y:e.clientY},this._longPressTimer=window.setTimeout(()=>{this._isLongPress=!0,this._resetUsage(),"vibrate"in navigator&&navigator.vibrate(50)},800)}_resetUsage(){if(this._validationMessages=[],!this._entitiesLoaded||!this.hass||!this.hass.callService)return void console.error("Timer-card: Cannot reset usage. Entities not loaded or callService unavailable.");const t=this._getEntryId();t?confirm("Reset daily usage to 00:00?\n\nThis action cannot be undone.")&&this.hass.callService(lt,"reset_daily_usage",{entry_id:t}).then(()=>{console.log("Timer-card: Daily usage reset successfully")}).catch(t=>{console.error("Timer-card: Error resetting daily usage:",t)}):console.error("Timer-card: Entry ID not found for resetting usage.")}_handleSliderChange(t){var e;const i=t.target;this._sliderValue=parseInt(i.value);const o=(null===(e=this._config)||void 0===e?void 0:e.timer_instance_id)||"default";localStorage.setItem(`simple-timer-slider-${o}`,this._sliderValue.toString())}_getCurrentTimerMode(){var t;if(!this._entitiesLoaded||!this.hass||!this._effectiveSensorEntity)return"normal";const e=this.hass.states[this._effectiveSensorEntity];return(null===(t=null==e?void 0:e.attributes)||void 0===t?void 0:t.reverse_mode)?"reverse":"normal"}_getSliderStyle(){var t,e,i;const o=(null===(t=this._config)||void 0===t?void 0:t.slider_thumb_color)||"#2ab69c",n=(null===(e=this._config)||void 0===e?void 0:e.slider_background_color)||"var(--secondary-background-color)",s=(null===(i=this._config)||void 0===i?void 0:i.slider_thumb_color)?this._adjustColorBrightness(o,20):"#4bd9bf",r=t=>{const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:{r:42,g:182,b:156}},a=r(o),l=r(s);return`\n      .timer-slider {\n        background: ${n} !important;\n      }\n      .timer-slider::-webkit-slider-thumb {\n        background: ${o} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 2px rgba(${l.r}, ${l.g}, ${l.b}, 0.3),\n          0 0 8px rgba(${a.r}, ${a.g}, ${a.b}, 0.4),\n          0 2px 4px rgba(0, 0, 0, 0.2) !important;\n      }\n      .timer-slider::-webkit-slider-thumb:hover {\n        background: ${this._adjustColorBrightness(o,-10)} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 3px rgba(${l.r}, ${l.g}, ${l.b}, 0.4),\n          0 0 12px rgba(${a.r}, ${a.g}, ${a.b}, 0.6),\n          0 2px 6px rgba(0, 0, 0, 0.3) !important;\n      }\n      .timer-slider::-webkit-slider-thumb:active {\n        background: ${this._adjustColorBrightness(o,-20)} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 4px rgba(${l.r}, ${l.g}, ${l.b}, 0.5),\n          0 0 16px rgba(${a.r}, ${a.g}, ${a.b}, 0.7),\n          0 2px 8px rgba(0, 0, 0, 0.4) !important;\n      }\n      .timer-slider::-moz-range-thumb {\n        background: ${o} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 2px rgba(${l.r}, ${l.g}, ${l.b}, 0.3),\n          0 0 8px rgba(${a.r}, ${a.g}, ${a.b}, 0.4),\n          0 2px 4px rgba(0, 0, 0, 0.2) !important;\n      }\n      .timer-slider::-moz-range-thumb:hover {\n        background: ${this._adjustColorBrightness(o,-10)} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 3px rgba(${l.r}, ${l.g}, ${l.b}, 0.4),\n          0 0 12px rgba(${a.r}, ${a.g}, ${a.b}, 0.6),\n          0 2px 6px rgba(0, 0, 0, 0.3) !important;\n      }\n      .timer-slider::-moz-range-thumb:active {\n        background: ${this._adjustColorBrightness(o,-20)} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 4px rgba(${l.r}, ${l.g}, ${l.b}, 0.5),\n          0 0 16px rgba(${a.r}, ${a.g}, ${a.b}, 0.7),\n          0 2px 8px rgba(0, 0, 0, 0.4) !important;\n      }\n    `}_getTimerButtonStyle(){var t,e;const i=null===(t=this._config)||void 0===t?void 0:t.timer_button_font_color,o=null===(e=this._config)||void 0===e?void 0:e.timer_button_background_color;if(!i&&!o)return"";let n="";return(i||o)&&(n+=`\n        .timer-button {\n          ${i?`color: ${i} !important;`:""}\n          ${o?`background-color: ${o} !important;`:""}\n        }\n      `),n}_getPowerButtonStyle(){var t,e;const i=null===(t=this._config)||void 0===t?void 0:t.power_button_background_color,o=null===(e=this._config)||void 0===e?void 0:e.power_button_icon_color;if(!i&&!o)return"";let n="";return(i||o)&&(n+=`\n        .power-button-small, .power-button-top-right {\n          ${i?`background-color: ${i} !important;`:""}\n        }\n        \n        .power-button-small ha-icon[icon], .power-button-top-right ha-icon[icon] {\n          ${o?`color: ${o} !important;`:""}\n        }\n        \n        .power-button-small.reverse ha-icon[icon], .power-button-top-right.reverse ha-icon[icon] {\n          ${o?`color: ${o} !important;`:""}\n        }\n      `),n}_adjustColorBrightness(t,e){const i=parseInt(t.replace("#",""),16),o=Math.round(2.55*e);return"#"+(16777216+65536*Math.max(0,Math.min(255,(i>>16)+o))+256*Math.max(0,Math.min(255,(i>>8&255)+o))+Math.max(0,Math.min(255,(255&i)+o))).toString(16).slice(1)}render(){var t,e,i,o,n,s,r,a,l,c,d,h;let u=null,_=!1;if(this.hass){if(!this._entitiesLoaded)if(null===(t=this._config)||void 0===t?void 0:t.timer_instance_id){const t=Object.values(this.hass.states).find(t=>t.attributes.entry_id===this._config.timer_instance_id&&t.entity_id.startsWith("sensor."));t?"string"==typeof t.attributes.switch_entity_id&&t.attributes.switch_entity_id&&this.hass.states[t.attributes.switch_entity_id]?(u="Loading Timer Control Card. Please wait...",_=!1):(u=`Timer Control Instance '${this._config.timer_instance_id}' linked to missing or invalid switch '${t.attributes.switch_entity_id}'. Please check instance configuration.`,_=!0):(u=`Timer Control Instance '${this._config.timer_instance_id}' not found. Please select a valid instance in the card editor.`,_=!0)}else if(null===(e=this._config)||void 0===e?void 0:e.sensor_entity){const t=this.hass.states[this._config.sensor_entity];t?"string"==typeof t.attributes.switch_entity_id&&t.attributes.switch_entity_id&&this.hass.states[t.attributes.switch_entity_id]?(u="Loading Timer Control Card. Please wait...",_=!1):(u=`Configured Timer Control Sensor '${this._config.sensor_entity}' is invalid or its linked switch '${t.attributes.switch_entity_id}' is missing. Please select a valid instance.`,_=!0):(u=`Configured Timer Control Sensor '${this._config.sensor_entity}' not found. Please select a valid instance in the card editor.`,_=!0)}else u="Select a Timer Control Instance from the dropdown in the card editor to link this card.",_=!1}else u="Home Assistant object (hass) not available. Card cannot load.",_=!0;if(u)return j`<ha-card><div class="${_?"warning":"placeholder"}">${u}</div></ha-card>`;const g=this.hass.states[this._effectiveSwitchEntity],p=this.hass.states[this._effectiveSensorEntity],m="on"===g.state,f="active"===p.attributes.timer_state,b=p.attributes.timer_duration||0,v=m&&!f,y=p.attributes.reverse_mode,$=parseFloat(p.state)||0;let w,x;if(this._getShowSeconds()){const t=Math.floor($),e=Math.floor(t/3600),i=Math.floor(t%3600/60),o=t%60;w=`Daily usage: ${e.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}`,x=this._timeRemaining||"00:00:00"}else{const t=Math.floor($/60),e=t%60;w=`Daily usage: ${Math.floor(t/60).toString().padStart(2,"0")}:${e.toString().padStart(2,"0")}`,x=this._timeRemaining||"00:00"}const S=p.attributes.watchdog_message,C=this._hasOrphanedTimer();return j`
        ...
        <div class="card-content">
          ...
          ${(null===(n=this._config)||void 0===n?void 0:n.hide_slider)?j`
             <div class="power-button-top-right ${f&&y?"on reverse":m?"on":this._config.reverse_mode?"reverse":""}"
               ...
               ${(null===(s=this._config)||void 0===s?void 0:s.power_button_icon)?j`<ha-icon icon="${this._config.power_button_icon}"></ha-icon>`:""}
             </div>
          `:""}
          ...
          <div class="slider-row">
            ...
            <div class="power-button-small ${f&&y?"on reverse":m?"on":(null===(d=this._config)||void 0===d?void 0:d.reverse_mode)?"reverse":""}" 
                 @click=${this._handlePowerClick}
                 title="Click to toggle power">
              ${(null===(h=this._config)||void 0===h?void 0:h.power_button_icon)?j`<ha-icon icon="${this._config.power_button_icon}"></ha-icon>`:""}
            </div>
          </div>
          `}
          ...
          <div class="button-grid">
            ${this.buttons.map(t=>{const e=f&&Math.abs(b-t.minutesEquivalent)<.001&&"button"===p.attributes.timer_start_method,i=v||f&&!e;return j`
    ...
    `}static get styles(){return at}}),window.customCards=window.customCards||[],window.customCards.push({type:"timer-card",name:"Simple Timer Card",description:"A card for the Simple Timer integration."});const dt=s`
      .card-config-group {
        padding: 16px;
...
`,ht="instance_title",ut=[15,30,60,90,120,150];class _t extends st{constructor(){super(),this._configFullyLoaded=!1,this._timerInstancesOptions=[],this._tempSliderMaxValue=null,this._allTimerOptions=[1,15,30,45,60,75,90,105,120,135,150,165,180],this._config={type:"custom:timer-card",timer_buttons:[...ut],timer_instance_id:null,card_title:null}}_getComputedCSSVariable(t,e="#000000"){try{const e=getComputedStyle(document.documentElement).getPropertyValue(t).trim();if(e&&""!==e)return e}catch(e){console.warn(`Failed to get CSS variable ${t}:`,e)}return e}_rgbToHex(t){const e=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*[\d.]+)?\)/);if(e){return"#"+((1<<24)+(parseInt(e[1])<<16)+(parseInt(e[2])<<8)+parseInt(e[3])).toString(16).slice(1)}return t}_getThemeColorHex(t,e="#000000"){const i=this._getComputedCSSVariable(t,e);return i.startsWith("#")?i:i.startsWith("rgb")?this._rgbToHex(i):e}async _getSimpleTimerInstances(){if(!this.hass||!this.hass.states)return console.warn("TimerCardEditor: hass.states not available when trying to fetch instances from states."),[];const t=new Map;for(const e in this.hass.states){const i=this.hass.states[e];if(e.startsWith("sensor.")&&e.includes("runtime")&&i.attributes.entry_id&&"string"==typeof i.attributes.entry_id&&i.attributes.switch_entity_id&&"string"==typeof i.attributes.switch_entity_id){const o=i.attributes.entry_id,n=i.attributes[ht];let s=`Timer Control (${o.substring(0,8)})`;console.debug(`TimerCardEditor: Processing sensor ${e} (Entry: ${o})`),console.debug(`TimerCardEditor: Found raw attribute '${ht}': ${n}`),console.debug("TimerCardEditor: Type of raw attribute: "+typeof n),n&&"string"==typeof n&&""!==n.trim()?(s=n.trim(),console.debug(`TimerCardEditor: Using '${ht}' for label: "${s}"`)):console.warn(`TimerCardEditor: Sensor '${e}' has no valid '${ht}' attribute. Falling back to entry ID based label: "${s}".`),t.has(o)?console.debug(`TimerCardEditor: Skipping duplicate entry_id: ${o}`):(t.set(o,{value:o,label:s}),console.debug(`TimerCardEditor: Added instance: ${s} (${o}) from sensor: ${e}`))}}const e=Array.from(t.values());return e.sort((t,e)=>t.label.localeCompare(e.label)),0===e.length&&console.info("TimerCardEditor: No Simple Timer integration instances found by scanning hass.states."),e}_getValidatedTimerButtons(t){if(Array.isArray(t)){const e=[],i=new Set;t.forEach(t=>{const o=String(t).trim().toLowerCase(),n=o.match(/^(\d+(?:\.\d+)?)\s*(s|sec|seconds|m|min|minutes|h|hr|hours)?$/);if(n){const s=parseFloat(n[1]),r=n[1].includes("."),a=n[2]||"min",l=a.startsWith("h")||["h","hr","hours"].includes(a);if(r&&!l)return;["m","min","minutes"].includes(a)?s>0&&s<=1e3&&(i.has(String(s))||(e.push(s),i.add(String(s)))):i.has(o)||(e.push(t),i.add(o))}});const o=e.filter(t=>"number"==typeof t),n=e.filter(t=>"string"==typeof t);return o.sort((t,e)=>t-e),n.sort(),[...o,...n]}return null==t?(console.log("TimerCardEditor: No timer_buttons in config, using empty array."),[]):(console.warn(`TimerCardEditor: Invalid timer_buttons type (${typeof t}):`,t,"- using empty array"),[])}async setConfig(t){const e=Object.assign({},this._config),i=this._getValidatedTimerButtons(t.timer_buttons),o={type:t.type||"custom:timer-card",timer_buttons:i,card_title:t.card_title||null,power_button_icon:t.power_button_icon||null,slider_max:t.slider_max||120,slider_unit:t.slider_unit||"min",reverse_mode:t.reverse_mode||!1,hide_slider:t.hide_slider||!1,show_daily_usage:!1!==t.show_daily_usage,slider_thumb_color:t.slider_thumb_color||null,slider_background_color:t.slider_background_color||null,timer_button_font_color:t.timer_button_font_color||null,timer_button_background_color:t.timer_button_background_color||null,power_button_background_color:t.power_button_background_color||null,power_button_icon_color:t.power_button_icon_color||null};t.timer_instance_id?o.timer_instance_id=t.timer_instance_id:console.info("TimerCardEditor: setConfig - no timer_instance_id in config, will remain unset"),t.entity&&(o.entity=t.entity),t.sensor_entity&&(o.sensor_entity=t.sensor_entity),this._config=o,this._configFullyLoaded=!0,JSON.stringify(e)!==JSON.stringify(this._config)?this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}})):console.log("TimerCardEditor: Config unchanged, not dispatching event"),this.requestUpdate()}connectedCallback(){super.connectedCallback(),this.hass?this._fetchTimerInstances():console.warn("TimerCardEditor: hass not available on connectedCallback. Deferring instance fetch.")}updated(t){var e;super.updated(t),t.has("hass")&&this.hass&&((null===(e=t.get("hass"))||void 0===e?void 0:e.states)===this.hass.states&&0!==this._timerInstancesOptions.length||this._fetchTimerInstances())}async _fetchTimerInstances(){var t;if(this.hass){if(this._timerInstancesOptions=await this._getSimpleTimerInstances(),!this._configFullyLoaded)return void this.requestUpdate();if((null===(t=this._config)||void 0===t?void 0:t.timer_instance_id)&&this._timerInstancesOptions.length>0){if(!this._timerInstancesOptions.some(t=>t.value===this._config.timer_instance_id)){console.warn(`TimerCardEditor: Previously configured instance '${this._config.timer_instance_id}' no longer exists. User will need to select a new instance.`);const t=Object.assign(Object.assign({},this._config),{timer_instance_id:null});this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}}else console.info("TimerCardEditor: No timer_instance_id configured or no instances available. User must manually select.");this.requestUpdate()}}_handleTimerCheckboxChange(t){var e,i,o,n,s,r,a,l,c,d,h,u,_,g,p,m,f;const b=t.target,v=parseInt(b.value),y=b.checked;let $=Array.isArray(null===(e=this._config)||void 0===e?void 0:e.timer_buttons)?[...this._config.timer_buttons]:[];y?$.includes(v)||$.push(v):$=$.filter(t=>t!==v);const w=$.filter(t=>"number"==typeof t),x=$.filter(t=>"string"==typeof t);w.sort((t,e)=>t-e),x.sort(),$=[...w,...x];const S={type:this._config.type,timer_buttons:$};(null===(i=this._config)||void 0===i?void 0:i.timer_instance_id)&&(S.timer_instance_id=this._config.timer_instance_id),(null===(o=this._config)||void 0===o?void 0:o.entity)&&(S.entity=this._config.entity),(null===(n=this._config)||void 0===n?void 0:n.sensor_entity)&&(S.sensor_entity=this._config.sensor_entity),(null===(s=this._config)||void 0===s?void 0:s.card_title)&&(S.card_title=this._config.card_title),(null===(r=this._config)||void 0===r?void 0:r.power_button_icon)&&(S.power_button_icon=this._config.power_button_icon),void 0!==(null===(a=this._config)||void 0===a?void 0:a.show_daily_usage)&&(S.show_daily_usage=this._config.show_daily_usage),void 0!==(null===(l=this._config)||void 0===l?void 0:l.slider_max)&&(S.slider_max=this._config.slider_max),void 0!==(null===(c=this._config)||void 0===c?void 0:c.slider_unit)&&(S.slider_unit=this._config.slider_unit),void 0!==(null===(d=this._config)||void 0===d?void 0:d.reverse_mode)&&(S.reverse_mode=this._config.reverse_mode),void 0!==(null===(h=this._config)||void 0===h?void 0:h.slider_thumb_color)&&(S.slider_thumb_color=this._config.slider_thumb_color),void 0!==(null===(u=this._config)||void 0===u?void 0:u.slider_background_color)&&(S.slider_background_color=this._config.slider_background_color),void 0!==(null===(_=this._config)||void 0===_?void 0:_.timer_button_font_color)&&(S.timer_button_font_color=this._config.timer_button_font_color),void 0!==(null===(g=this._config)||void 0===g?void 0:g.timer_button_background_color)&&(S.timer_button_background_color=this._config.timer_button_background_color),void 0!==(null===(p=this._config)||void 0===p?void 0:p.power_button_background_color)&&(S.power_button_background_color=this._config.power_button_background_color),void 0!==(null===(m=this._config)||void 0===m?void 0:m.power_button_icon_color)&&(S.power_button_icon_color=this._config.power_button_icon_color),void 0!==(null===(f=this._config)||void 0===f?void 0:f.hide_slider)&&(S.hide_slider=this._config.hide_slider),this._config=S,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0})),this.requestUpdate()}render(){var t,e,i,o,n,s,r,a,l,c,d,h,u,_,g,p,m,f,b,v,y,$,w,x,S;if(!this.hass)return j``;const C=this._timerInstancesOptions||[],E=[{value:"",label:"None"}],k=null!==(t=this._tempSliderMaxValue)&&void 0!==t?t:String(null!==(e=this._config.slider_max)&&void 0!==e?e:120);C.length>0?E.push(...C):E.push({value:"none_found",label:"No Simple Timer Instances Found"});const T=this._getThemeColorHex("--secondary-background-color","#424242"),A=this._getThemeColorHex("--primary-text-color","#ffffff"),P=this._getThemeColorHex("--secondary-background-color","#424242"),M=this._getThemeColorHex("--secondary-background-color","#424242"),I=this._getThemeColorHex("--primary-color","#03a9f4");return j`
      <div class="card-config">
        ...
        <div class="config-row">
          ...
          >
            ${(null===(s=this._config)||void 0===s?void 0:s.power_button_icon)?j`
        ...
        <div class="config-row">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(r=this._config)||void 0===r?void 0:r.slider_thumb_color)||"#2ab69c"}
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(l=this._config)||void 0===l?void 0:l.slider_background_color)||T}
        ...
        <div class="config-row">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(d=this._config)||void 0===d?void 0:d.timer_button_font_color)||A}
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(u=this._config)||void 0===u?void 0:u.timer_button_background_color)||P}
        ...
        <div class="config-row">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(g=this._config)||void 0===g?void 0:g.power_button_background_color)||M}
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(m=this._config)||void 0===m?void 0:m.power_button_icon_color)||I}
        ...
        <div class="config-row">
          <ha-formfield .label=${"Reverse Mode (Delayed Start)"}>
            <ha-switch
              ...
              .disabled=${null===(y=this._config)||void 0===y?void 0:y.hide_slider}
        ...
        <div class="config-row">
          <ha-formfield .label=${"Hide Timer Slider"}>
            <ha-switch
              .checked=${(null===($=this._config)||void 0===$?void 0:$.hide_slider)||!1}
        ...
        <div class="config-row">
          <ha-formfield .label=${"Show Daily Usage"}>
            <ha-switch
              .checked=${!1!==(null===(w=this._config)||void 0===w?void 0:w.show_daily_usage)}
