 ...
 */class st extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const o=i?.renderBefore??e;let n=o._$litPart$;if(void 0===n){const t=i?.renderBefore??null;o._$litPart$=n=new Y(e.insertBefore(P(),t),t,void 0,i??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return H}}st._$litElement$=!0,st.finalized=!0,nt.litElementHydrateSupport?.({LitElement:st});const rt=nt.litElementPolyfillSupport;rt?.({LitElement:st}),(nt.litElementVersions??=[]).push("4.2.0");const at=s`
  ...
  `,lt="simple_timer",dt=[15,30,60,90,120,150];console.info("%c SIMPLE-TIMER-CARD %c v1.4.1 ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");customElements.define("timer-card",class extends st{constructor(){super(...arguments),this._countdownInterval=null,this._liveRuntimeSeconds=0,this._timeRemaining=null,this._sliderValue=0,this.buttons=[],this._validationMessages=[],this._isDuplicate=!1,this._notificationSentForCurrentCycle=!1,this._entitiesLoaded=!1,this._effectiveSwitchEntity=null,this._effectiveSensorEntity=null,this._longPressTimer=null,this._isLongPress=!1,this._touchStartPosition=null,this._isCancelling=!1}static get properties(){return{hass:{type:Object},_config:{type:Object},_timeRemaining:{state:!0},_sliderValue:{state:!0},_entitiesLoaded:{state:!0},_effectiveSwitchEntity:{state:!0},_effectiveSensorEntity:{state:!0},_validationMessages:{state:!0},_isDuplicate:{state:!0}}}static async getConfigElement(){return await Promise.resolve().then(function(){return pt}),document.createElement("timer-card-editor")}static getStubConfig(t){return console.log("TimerCard: Generating stub config - NO auto-selection will be performed"),{type:"custom:timer-card",timer_instance_id:null,timer_buttons:[...dt],card_title:"Simple Timer",power_button_icon:"mdi:power",hide_slider:!1,slider_thumb_color:null,slider_background_color:null,power_button_background_color:null,power_button_icon_color:null}}setConfig(t){const e=t.slider_max&&t.slider_max>0&&t.slider_max<=9999?t.slider_max:120,i=t.timer_instance_id||"default";this.buttons=this._getValidatedTimerButtons(t.timer_buttons),this._config={type:t.type||"custom:timer-card",timer_buttons:t.timer_buttons||[...dt],card_title:t.card_title||null,entity_state_icon:t.entity_state_icon||null,power_button_icon:t.power_button_icon||null,slider_max:e,slider_unit:t.slider_unit||"min",reverse_mode:t.reverse_mode||!1,hide_slider:t.hide_slider||!1,show_daily_usage:!1!==t.show_daily_usage,timer_instance_id:i,entity:t.entity,sensor_entity:t.sensor_entity,slider_thumb_color:t.slider_thumb_color||null,slider_background_color:t.slider_background_color||null,timer_button_font_color:t.timer_button_font_color||null,timer_button_background_color:t.timer_button_background_color||null,power_button_background_color:t.power_button_background_color||null,power_button_icon_color:t.power_button_icon_color||null,entity_state_button_background_color:t.entity_state_button_background_color||null,entity_state_button_icon_color:t.entity_state_button_icon_color||null,entity_state_button_background_color_on:t.entity_state_button_background_color_on||null,entity_state_button_icon_color_on:t.entity_state_button_icon_color_on||null,turn_off_on_cancel:!1!==t.turn_off_on_cancel,use_default_timer:t.use_default_timer||!1},t.timer_instance_id&&(this._config.timer_instance_id=t.timer_instance_id),t.entity&&(this._config.entity=t.entity),t.sensor_entity&&(this._config.sensor_entity=t.sensor_entity);const o=localStorage.getItem(`simple-timer-slider-${i}`);let n=o?parseInt(o):NaN;(isNaN(n)||n<0)&&(n=e),n>e&&(n=e),this._sliderValue=n,localStorage.setItem(`simple-timer-slider-${i}`,this._sliderValue.toString()),this.requestUpdate(),this._liveRuntimeSeconds=0,this._notificationSentForCurrentCycle=!1,this._effectiveSwitchEntity=null,this._effectiveSensorEntity=null,this._entitiesLoaded=!1}_getValidatedTimerButtons(t){let e=[];if(this._validationMessages=[],Array.isArray(t)){const i=[],o=new Set,n=[];t.forEach(t=>{let s,r,a="min",l="Min";const d=String(t).trim().toLowerCase().match(/^(\d+(?:\.\d+)?)\s*(s|sec|seconds|m|min|minutes|h|hr|hours|d|day|days)?(\*)?$/);if(d){const c=parseFloat(d[1]),h=d[1].includes("."),u=d[2]||"min",_=!!d[3],p=u.startsWith("h"),g=u.startsWith("d");if(c>9999)return void i.push(t);if(h&&!p&&!g)return void i.push(t);if(h&&(p||g)){const e=d[1].split(".")[1];if(e&&e.length>1)return void i.push(t)}if(s=c,u.startsWith("s")?(a="s",l="sec",r=s/60):u.startsWith("h")?(a="h",l="hr",r=60*s):u.startsWith("d")?(a="d",l="day",r=1440*s):(a="min",l="min",r=s),s>0){const i=`${r}`;_?e.push({displayValue:s,unit:a,labelUnit:l,minutesEquivalent:r,isDefault:_}):o.has(i)?n.push(t):(o.add(i),e.push({displayValue:s,unit:a,labelUnit:l,minutesEquivalent:r,isDefault:_}))}else i.push(t)}else i.push(t)});const s=[];return i.length>0&&s.push(`Invalid timer values ignored: ${i.join(", ")}. Format example: 30, "30s", "1h", "2d". Limit 9999.`),n.length>0&&s.push("Duplicate timer values were removed."),this._validationMessages=s,e.sort((t,e)=>t.minutesEquivalent-e.minutesEquivalent),e}return null==t||(console.warn(`TimerCard: Invalid timer_buttons type (${typeof t}):`,t,"- using empty array"),this._validationMessages=[`Invalid timer_buttons configuration. Expected array, got ${typeof t}.`]),[]}_determineEffectiveEntities(){var t,e;let i=null,o=null,n=!1;if(this.hass&&this.hass.states){if(null===(t=this._config)||void 0===t?void 0:t.timer_instance_id){const t=this._config.timer_instance_id,e=Object.keys(this.hass.states).filter(t=>t.startsWith("sensor.")).find(e=>{const i=this.hass.states[e];return i.attributes.entry_id===t&&"string"==typeof i.attributes.switch_entity_id});if(e){o=e,i=this.hass.states[e].attributes.switch_entity_id,i&&this.hass.states[i]?n=!0:console.warn(`TimerCard: Configured instance '${t}' sensor '${o}' links to missing or invalid switch '${i}'.`)}else console.warn(`TimerCard: Configured timer_instance_id '${t}' does not have a corresponding simple_timer sensor found.`)}if(!n&&(null===(e=this._config)||void 0===e?void 0:e.sensor_entity)){const t=this.hass.states[this._config.sensor_entity];t&&"string"==typeof t.attributes.entry_id&&"string"==typeof t.attributes.switch_entity_id?(o=this._config.sensor_entity,i=t.attributes.switch_entity_id,i&&this.hass.states[i]?(n=!0,console.info(`TimerCard: Using manually configured sensor_entity: Sensor '${o}', Switch '${i}'.`)):console.warn(`TimerCard: Manually configured sensor '${o}' links to missing or invalid switch '${i}'.`)):console.warn(`TimerCard: Manually configured sensor_entity '${this._config.sensor_entity}' not found or missing required attributes.`)}this._effectiveSwitchEntity===i&&this._effectiveSensorEntity===o||(this._effectiveSwitchEntity=i,this._effectiveSensorEntity=o,this.requestUpdate()),this._entitiesLoaded=n}else this._entitiesLoaded=!1}_getEntryId(){if(!this._effectiveSensorEntity||!this.hass||!this.hass.states)return console.error("Timer-card: _getEntryId called without a valid effective sensor entity."),null;const t=this.hass.states[this._effectiveSensorEntity];return t&&t.attributes.entry_id?t.attributes.entry_id:(console.error("Could not determine entry_id from effective sensor_entity attributes:",this._effectiveSensorEntity),null)}_startTimer(t,e="min",i="button"){var o;if(this._validationMessages=[],!this._entitiesLoaded||!this.hass||!this.hass.callService)return void console.error("Timer-card: Cannot start timer. Entities not loaded or callService unavailable.");const n=this._getEntryId();if(!n)return void console.error("Timer-card: Entry ID not found for starting timer.");this._effectiveSwitchEntity;(null===(o=this._config)||void 0===o?void 0:o.reverse_mode)||!1?this.hass.callService(lt,"start_timer",{entry_id:n,duration:t,unit:e,reverse_mode:!0,start_method:i}):this.hass.callService(lt,"start_timer",{entry_id:n,duration:t,unit:e,start_method:i}),this._notificationSentForCurrentCycle=!1}_addTimer(t,e="min"){if(this._validationMessages=[],!this._entitiesLoaded||!this.hass||!this.hass.callService)return void console.error("Timer-card: Cannot add to timer. Entities not loaded or callService unavailable.");const i=this._getEntryId();i?this.hass.callService(lt,"add_timer",{entry_id:i,duration:t,unit:e}).then(()=>{console.log(`Timer-card: Added ${t} ${e} to active timer.`)}).catch(t=>{console.error("Timer-card: Error adding to timer:",t)}):console.error("Timer-card: Entry ID not found for adding to timer.")}_cancelTimer(){var t;if(this._validationMessages=[],!this._entitiesLoaded||!this.hass||!this.hass.callService)return void console.error("Timer-card: Cannot cancel timer. Entities not loaded or callService unavailable.");this._isCancelling=!0;const e=this._getEntryId();if(!e)return console.error("Timer-card: Entry ID not found for cancelling timer."),void(this._isCancelling=!1);const i=!1!==(null===(t=this._config)||void 0===t?void 0:t.turn_off_on_cancel);this.hass.callService(lt,"cancel_timer",{entry_id:e,turn_off_entity:i}).then(()=>{setTimeout(()=>{this._isCancelling=!1},1e3)}).catch(t=>{console.error("Timer-card: Error cancelling timer:",t),this._isCancelling=!1}),this._notificationSentForCurrentCycle=!1}_handleTimerControl(){var t;if(this._validationMessages=[],!this._entitiesLoaded||!this.hass||!this.hass.states)return void console.error("Timer-card: Cannot control timer. Entities not loaded.");const e=this._effectiveSensorEntity,i=this.hass.states[e];if(!i)return void console.error("Timer-card: Sensor entity not found.");if("active"===i.attributes.timer_state)return this._cancelTimer(),void console.log("Timer-card: Stopping active timer.");if(this._sliderValue>0){const e=(null===(t=this._config)||void 0===t?void 0:t.slider_unit)||"min";this._startTimer(this._sliderValue,e,"slider"),console.log(`Timer-card: Starting timer for ${this._sliderValue} ${e}`)}else console.warn("Timer-card: Slider value is 0, cannot start timer.")}_handleIndependentPower(t){if(t.preventDefault(),t.stopPropagation(),!this._entitiesLoaded||!this.hass||!this._effectiveSwitchEntity)return void console.error("Timer-card: Cannot toggle power. Entities not loaded.");const e=this._effectiveSwitchEntity;console.log(`Timer-card: Toggling independent power for ${e}`),this.hass.callService("homeassistant","toggle",{entity_id:e}).catch(t=>console.error("Timer-card: Error toggling power:",t))}_showMoreInfo(){if(!this._entitiesLoaded||!this.hass)return void console.error("Timer-card: Cannot show more info. Entities not loaded.");const t=this._effectiveSensorEntity,e=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}});this.dispatchEvent(e)}connectedCallback(){var t,e;super.connectedCallback(),this._checkDuplicateUsage();const i=(null===(t=this._config)||void 0===t?void 0:t.timer_instance_id)||"default";if(localStorage.getItem(`simple-timer-slider-${i}`));else if(this._determineEffectiveEntities(),this._entitiesLoaded&&this.hass&&this._effectiveSensorEntity){const t=this.hass.states[this._effectiveSensorEntity],i=(null===(e=null==t?void 0:t.attributes)||void 0===e?void 0:e.timer_duration)||0;i>0&&i<=120&&(this._sliderValue=i)}this._determineEffectiveEntities(),this._updateLiveRuntime(),this._updateCountdown()}disconnectedCallback(){super.disconnectedCallback(),this._stopCountdown(),this._stopLiveRuntime(),this._longPressTimer&&window.clearTimeout(this._longPressTimer)}updated(t){(t.has("hass")||t.has("_config"))&&(this._determineEffectiveEntities(),this._updateLiveRuntime(),this._updateCountdown()),t.has("_config")&&(this._syncDefaultTimer(),this._checkDuplicateUsage())}_syncDefaultTimer(){if(!this._config)return;if(!this._entitiesLoaded||!this.hass||!this._effectiveSensorEntity)return void console.warn("Timer-card: Sync skipped - entities not loaded or missing dependencies",{loaded:this._entitiesLoaded,hasHass:!!this.hass,sensor:this._effectiveSensorEntity});const t=this.hass.states[this._effectiveSensorEntity];if(!t)return void console.warn("Timer-card: Sync skipped - sensor state not found",this._effectiveSensorEntity);const e=t.attributes.entry_id;if(!e)return void console.warn("Timer-card: Sync skipped - entry_id not found in sensor attributes");const i=this._config.reverse_mode||!1;let o=this._config.use_default_timer||!1;i&&(o=!1);let n=0,s="min";const r=this.buttons.find(t=>t.isDefault);r?(n=r.displayValue,s=r.unit):o=!1;const a=t.attributes.default_timer_enabled,l=t.attributes.default_timer_duration||0,d=t.attributes.default_timer_unit||"min";(o!==a||o&&(Math.abs(n-l)>.001||s!==d))&&(console.info("Timer-card: Syncing default timer to backend..."),this.hass.callService(lt,"set_default_timer_config",{entry_id:e,enabled:o,duration:n,unit:s}).then(()=>console.log("Timer-card: Sync successful")).catch(t=>console.error("Timer-card: Failed to sync default timer config:",t)))}_updateLiveRuntime(){this._liveRuntimeSeconds=0}_stopLiveRuntime(){this._liveRuntimeSeconds=0}_updateCountdown(){if(!this._entitiesLoaded||!this.hass||!this.hass.states)return void this._stopCountdown();const t=this.hass.states[this._effectiveSensorEntity];if(!t||"active"!==t.attributes.timer_state)return this._stopCountdown(),void(this._notificationSentForCurrentCycle=!1);const e=t.attributes.timer_finishes_at;if(void 0===e)return console.warn("Timer-card: timer_finishes_at is undefined for active timer. Stopping countdown."),void this._stopCountdown();const i=new Date(e).getTime();if(this._countdownInterval&&this._currentFinishesAt!==i&&this._stopCountdown(),this._currentFinishesAt=i,!this._countdownInterval){const t=()=>{const t=(new Date).getTime(),e=Math.max(0,Math.round((i-t)/1e3));if(this._getShowSeconds()){const t=Math.floor(e/3600),i=Math.floor(e%3600/60),o=e%60;this._timeRemaining=`${t.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}`}else{const t=Math.floor(e/60),i=e%60;this._timeRemaining=`${t.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}`}0===e&&(this._stopCountdown(),this._notificationSentForCurrentCycle||(this._notificationSentForCurrentCycle=!0))};this._countdownInterval=window.setInterval(t,500),t()}}_stopCountdown(){this._countdownInterval&&(window.clearInterval(this._countdownInterval),this._countdownInterval=null),this._timeRemaining=null}_getShowSeconds(){var t;if(!this._entitiesLoaded||!this.hass||!this._effectiveSensorEntity)return!1;const e=this.hass.states[this._effectiveSensorEntity];return(null===(t=null==e?void 0:e.attributes)||void 0===t?void 0:t.show_seconds)||!1}_handleUsageClick(t){t.preventDefault(),this._isLongPress||this._showMoreInfo(),this._isLongPress=!1}_startLongPress(t){t.preventDefault(),this._isLongPress=!1,this._longPressTimer=window.setTimeout(()=>{this._isLongPress=!0,this._resetUsage(),"vibrate"in navigator&&navigator.vibrate(50)},800)}_endLongPress(t){t&&t.preventDefault(),this._longPressTimer&&(window.clearTimeout(this._longPressTimer),this._longPressTimer=null)}_handlePowerClick(t){"click"!==t.type||this._isLongPress||(t.preventDefault(),t.stopPropagation(),this._handleTimerControl()),this._isLongPress=!1}_handleTouchEnd(t){t.preventDefault(),t.stopPropagation(),this._longPressTimer&&(window.clearTimeout(this._longPressTimer),this._longPressTimer=null);let e=!1;if(this._touchStartPosition&&t.changedTouches[0]){const i=t.changedTouches[0],o=Math.abs(i.clientX-this._touchStartPosition.x),n=Math.abs(i.clientY-this._touchStartPosition.y),s=10;e=o>s||n>s}this._isLongPress||e||this._showMoreInfo(),this._isLongPress=!1,this._touchStartPosition=null}_handleTouchStart(t){t.preventDefault(),t.stopPropagation(),this._isLongPress=!1;const e=t.touches[0];this._touchStartPosition={x:e.clientX,y:e.clientY},this._longPressTimer=window.setTimeout(()=>{this._isLongPress=!0,this._resetUsage(),"vibrate"in navigator&&navigator.vibrate(50)},800)}_resetUsage(){if(this._validationMessages=[],!this._entitiesLoaded||!this.hass||!this.hass.callService)return void console.error("Timer-card: Cannot reset usage. Entities not loaded or callService unavailable.");const t=this._getEntryId();t?confirm("Reset daily usage to 00:00?\n\nThis action cannot be undone.")&&this.hass.callService(lt,"reset_daily_usage",{entry_id:t}).then(()=>{console.log("Timer-card: Daily usage reset successfully")}).catch(t=>{console.error("Timer-card: Error resetting daily usage:",t)}):console.error("Timer-card: Entry ID not found for resetting usage.")}_handleSliderChange(t){var e;const i=t.target;this._sliderValue=parseInt(i.value);const o=(null===(e=this._config)||void 0===e?void 0:e.timer_instance_id)||"default";localStorage.setItem(`simple-timer-slider-${o}`,this._sliderValue.toString())}_getCurrentTimerMode(){var t;if(!this._entitiesLoaded||!this.hass||!this._effectiveSensorEntity)return"normal";const e=this.hass.states[this._effectiveSensorEntity];return(null===(t=null==e?void 0:e.attributes)||void 0===t?void 0:t.reverse_mode)?"reverse":"normal"}_getSliderStyle(){var t,e,i;const o=(null===(t=this._config)||void 0===t?void 0:t.slider_thumb_color)||"#2ab69c",n=(null===(e=this._config)||void 0===e?void 0:e.slider_background_color)||"var(--secondary-background-color)",s=(null===(i=this._config)||void 0===i?void 0:i.slider_thumb_color)?this._adjustColorBrightness(o,20):"#4bd9bf",r=t=>{const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:{r:42,g:182,b:156}},a=r(o),l=r(s);return`\n      .timer-slider {\n        background: ${n} !important;\n      }\n      .timer-slider::-webkit-slider-thumb {\n        background: ${o} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 2px rgba(${l.r}, ${l.g}, ${l.b}, 0.3),\n          0 0 8px rgba(${a.r}, ${a.g}, ${a.b}, 0.4),\n          0 2px 4px rgba(0, 0, 0, 0.2) !important;\n      }\n      .timer-slider::-webkit-slider-thumb:hover {\n        background: ${this._adjustColorBrightness(o,-10)} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 3px rgba(${l.r}, ${l.g}, ${l.b}, 0.4),\n          0 0 12px rgba(${a.r}, ${a.g}, ${a.b}, 0.6),\n          0 2px 6px rgba(0, 0, 0, 0.3) !important;\n      }\n      .timer-slider::-webkit-slider-thumb:active {\n        background: ${this._adjustColorBrightness(o,-20)} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 4px rgba(${l.r}, ${l.g}, ${l.b}, 0.5),\n          0 0 16px rgba(${a.r}, ${a.g}, ${a.b}, 0.7),\n          0 2px 8px rgba(0, 0, 0, 0.4) !important;\n      }\n      .timer-slider::-moz-range-thumb {\n        background: ${o} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 2px rgba(${l.r}, ${l.g}, ${l.b}, 0.3),\n          0 0 8px rgba(${a.r}, ${a.g}, ${a.b}, 0.4),\n          0 2px 4px rgba(0, 0, 0, 0.2) !important;\n      }\n      .timer-slider::-moz-range-thumb:hover {\n        background: ${this._adjustColorBrightness(o,-10)} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 3px rgba(${l.r}, ${l.g}, ${l.b}, 0.4),\n          0 0 12px rgba(${a.r}, ${a.g}, ${a.b}, 0.6),\n          0 2px 6px rgba(0, 0, 0, 0.3) !important;\n      }\n      .timer-slider::-moz-range-thumb:active {\n        background: ${this._adjustColorBrightness(o,-20)} !important;\n        border: 2px solid ${s} !important;\n        box-shadow: \n          0 0 0 4px rgba(${l.r}, ${l.g}, ${l.b}, 0.5),\n          0 0 16px rgba(${a.r}, ${a.g}, ${a.b}, 0.7),\n          0 2px 8px rgba(0, 0, 0, 0.4) !important;\n      }\n    `}_getTimerButtonStyle(){var t,e;const i=null===(t=this._config)||void 0===t?void 0:t.timer_button_font_color,o=null===(e=this._config)||void 0===e?void 0:e.timer_button_background_color;if(!i&&!o)return"";let n="";return(i||o)&&(n+=`\n        .timer-button {\n          ${i?`color: ${i} !important;`:""}\n          ${o?`background-color: ${o} !important;`:""}\n        }\n      `),n}_getPowerButtonStyle(){var t,e,i,o,n,s;const r=null===(t=this._config)||void 0===t?void 0:t.power_button_background_color,a=null===(e=this._config)||void 0===e?void 0:e.power_button_icon_color,l=null===(i=this._config)||void 0===i?void 0:i.entity_state_button_background_color,d=null===(o=this._config)||void 0===o?void 0:o.entity_state_button_icon_color,c=null===(n=this._config)||void 0===n?void 0:n.entity_state_button_background_color_on,h=null===(s=this._config)||void 0===s?void 0:s.entity_state_button_icon_color_on;if(!(r||a||l||d||c||h))return"";let u="";return(r||a)&&(u+=`\n        .timer-control-button {\n          ${r?`background-color: ${r} !important;`:""}\n        }\n        .timer-control-button ha-icon[icon] {\n          ${a?`color: ${a} !important;`:""}\n        }\n        .timer-control-button.reverse ha-icon[icon] {\n          ${a?`color: ${a} !important;`:""}\n        }\n      `),(l||d)&&(u+=`\n        .entity-state-button {\n          ${l?`background-color: ${l} !important;`:""}\n        }\n        .entity-state-button ha-icon[icon] {\n          ${d?`color: ${d} !important;`:""}\n        }\n        .entity-state-button.reverse ha-icon[icon] {\n          ${d?`color: ${d} !important;`:""}\n        }\n      `),(c||h)&&(u+=`\n        .entity-state-button.on {\n          ${c?`background-color: ${c} !important;`:""}\n        }\n        .entity-state-button.on ha-icon[icon] {\n          ${h?`color: ${h} !important;`:""}\n        }\n        /* Ensure specific override if needed */\n        .entity-state-button.on.reverse ha-icon[icon] {\n          ${h?`color: ${h} !important;`:""}\n        }\n      `),u}_adjustColorBrightness(t,e){const i=parseInt(t.replace("#",""),16),o=Math.round(2.55*e);return"#"+(16777216+65536*Math.max(0,Math.min(255,(i>>16)+o))+256*Math.max(0,Math.min(255,(i>>8&255)+o))+Math.max(0,Math.min(255,(255&i)+o))).toString(16).slice(1)}async _fetchLovelaceConfig(){if(!this.hass)return null;try{const t=this._getDashboardUrlPath();return await this.hass.callWS({type:"lovelace/config",url_path:t})}catch(t){return console.warn("TimerCard: Failed to fetch lovelace config",t),null}}_getDashboardUrlPath(){const t=window.location.pathname.split("/");return t.length>1&&"lovelace"!==t[1]?t[1]:null}_findUsedTimerInstances(t){const e=[];if(!t)return e;const i=t=>{t&&"object"==typeof t&&("custom:timer-card"===t.type&&t.timer_instance_id&&e.push(t.timer_instance_id),["views","cards","sections","badges"].forEach(e=>{Array.isArray(t[e])&&t[e].forEach(i)}),t.card&&i(t.card))};return i(t),e}async _checkDuplicateUsage(){var t;if(!(null===(t=this._config)||void 0===t?void 0:t.timer_instance_id)||!this.hass)return;const e=await this._fetchLovelaceConfig(),i=this._findUsedTimerInstances(e),o=this._config.timer_instance_id;i.filter(t=>t===o).length>1?this._isDuplicate||(console.warn(`TimerCard: Duplicate instance usage detected for '${o}'. Blocking card.`),this._isDuplicate=!0):this._isDuplicate&&(this._isDuplicate=!1)}render(){var t,e,i,o,n,s,r,a,l,d,c,h,u,_;if(this._isDuplicate){let i=null===(t=this._config)||void 0===t?void 0:t.timer_instance_id;if(this.hass&&(null===(e=this._config)||void 0===e?void 0:e.timer_instance_id)){const t=Object.keys(this.hass.states).filter(t=>t.startsWith("sensor.")).find(t=>this.hass.states[t].attributes.entry_id===this._config.timer_instance_id);if(t){const e=this.hass.states[t];i=e.attributes.instance_title||e.attributes.friendly_name||i}}return R`
        <ha-card style="background: #ff9800; color: white; padding: 16px;">
          ...
          <p>This timer instance ('${i}') is controlled by another card on this dashboard.</p>
          <p>Either remove the duplicate card or edit this card and select a unique timer instance.</p>
        </ha-card>
      `}let p=null,g=!1;if(this.hass){if(!this._entitiesLoaded)if(null===(i=this._config)||void 0===i?void 0:i.timer_instance_id){const t=Object.values(this.hass.states).find(t=>t.attributes.entry_id===this._config.timer_instance_id&&t.entity_id.startsWith("sensor."));t?"string"==typeof t.attributes.switch_entity_id&&t.attributes.switch_entity_id&&this.hass.states[t.attributes.switch_entity_id]?(p="Loading Timer Control Card. Please wait...",g=!1):(p=`Timer Control Instance '${this._config.timer_instance_id}' linked to missing or invalid switch '${t.attributes.switch_entity_id}'. Please check instance configuration.`,g=!0):(p="Please select a valid instance in the card editor.",g=!0)}else if(null===(o=this._config)||void 0===o?void 0:o.sensor_entity){const t=this.hass.states[this._config.sensor_entity];t?"string"==typeof t.attributes.switch_entity_id&&t.attributes.switch_entity_id&&this.hass.states[t.attributes.switch_entity_id]?(p="Loading Timer Control Card. Please wait...",g=!1):(p=`Configured Timer Control Sensor '${this._config.sensor_entity}' is invalid or its linked switch '${t.attributes.switch_entity_id}' is missing. Please select a valid instance.`,g=!0):(p=`Configured Timer Control Sensor '${this._config.sensor_entity}' not found. Please select a valid instance in the card editor.`,g=!0)}else p="Select a Timer Control Instance from the dropdown in the card editor to link this card.",g=!1}else p="Home Assistant object (hass) not available. Card cannot load.",g=!0;if(p)return R`<ha-card><div class="${g?"warning":"placeholder"}">${p}</div></ha-card>`;const m=this.hass.states[this._effectiveSwitchEntity],f=this.hass.states[this._effectiveSensorEntity],v="on"===m.state,b="active"===f.attributes.timer_state,y=f.attributes.timer_duration||0,$=f.attributes.reverse_mode,x=parseFloat(f.state)||0;let w,S;if(this._getShowSeconds()){const t=Math.floor(x),e=Math.floor(t/3600),i=Math.floor(t%3600/60),o=t%60;w=`Daily usage: ${e.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}:${o.toString().padStart(2,"0")}`,S=this._timeRemaining||"00:00:00"}else{const t=Math.floor(x/60),e=t%60;w=`Daily usage: ${Math.floor(t/60).toString().padStart(2,"0")}:${e.toString().padStart(2,"0")}`,S=this._timeRemaining||"00:00"}const C=f.attributes.watchdog_message;return R`
      <style>
      ...
      <ha-card>
        <div class="card-header ${(null===(n=this._config)||void 0===n?void 0:n.card_title)?"has-title":""}">
        ...
        <div class="card-content">
          ...
          <div class="entity-state-button ${v?"on":""}"
                @click=${this._handleIndependentPower}
                title="Toggle Power (Independent)">
            <ha-icon icon="${(null===(r=this._config)||void 0===r?void 0:r.entity_state_icon)||(null===(a=this._config)||void 0===a?void 0:a.power_button_icon)||"mdi:power"}"></ha-icon>
          </div>
          ...
          <div class="countdown-section">
            <div class="countdown-display ${b?"active":""} ${$?"reverse":""}">
              ${S}
            </div>
						${!1!==(null===(l=this._config)||void 0===l?void 0:l.show_daily_usage)?R`
          ...
          <!-- Slider Row -->
          ${(null===(d=this._config)||void 0===d?void 0:d.hide_slider)?"":R`
          <div class="slider-row">
            ...
            <div class="slider-right-group">
                <span class="slider-label">${this._sliderValue} ${(null===(h=this._config)||void 0===h?void 0:h.slider_unit)||"min"}</span>
          ...
          `}
           ...
           <!-- Timer Buttons Grid -->
           ${this.buttons.length>0||(null===(u=this._config)||void 0===u?void 0:u.hide_slider)&&b?R`
          <div class="button-grid">
            ${this.buttons.map(t=>{if(t.isDefault)return"";const e=b&&Math.abs(y-t.minutesEquivalent)<.001&&"button"===f.attributes.timer_start_method;return R`
            ...
            ${(null===(_=this._config)||void 0===_?void 0:_.hide_slider)?R`
    ...
    `}static get styles(){return at}}),window.customCards=window.customCards||[],window.customCards.push({type:"timer-card",name:"Simple Timer Card",description:"A card for the Simple Timer integration."});const ct=s`
      .card-config-group {
        padding: 16px;
...
`,ht="instance_title",ut=[15,30,60,90,120,150];class _t extends st{constructor(){super(),this._configFullyLoaded=!1,this._timerInstancesOptions=[],this._usedInstances=new Set,this._tempSliderMaxValue=null,this._newTimerButtonValue="",this._config={type:"custom:timer-card",timer_buttons:[...ut],timer_instance_id:null,card_title:null}}_getComputedCSSVariable(t,e="#000000"){try{const e=getComputedStyle(document.documentElement).getPropertyValue(t).trim();if(e&&""!==e)return e}catch(e){console.warn(`Failed to get CSS variable ${t}:`,e)}return e}_rgbToHex(t){const e=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*[\d.]+)?\)/);if(e){return"#"+((1<<24)+(parseInt(e[1])<<16)+(parseInt(e[2])<<8)+parseInt(e[3])).toString(16).slice(1)}return t}_getThemeColorHex(t,e="#000000"){const i=this._getComputedCSSVariable(t,e);return i.startsWith("#")?i:i.startsWith("rgb")?this._rgbToHex(i):e}async _getSimpleTimerInstances(){if(!this.hass||!this.hass.states)return console.warn("TimerCardEditor: hass.states not available when trying to fetch instances from states."),[];const t=new Map;for(const e in this.hass.states){const i=this.hass.states[e];if(e.startsWith("sensor.")&&e.includes("runtime")&&i.attributes.entry_id&&"string"==typeof i.attributes.entry_id&&i.attributes.switch_entity_id&&"string"==typeof i.attributes.switch_entity_id){const o=i.attributes.entry_id,n=i.attributes[ht];let s=`Timer Control (${o.substring(0,8)})`;console.debug(`TimerCardEditor: Processing sensor ${e} (Entry: ${o})`),console.debug(`TimerCardEditor: Found raw attribute '${ht}': ${n}`),console.debug("TimerCardEditor: Type of raw attribute: "+typeof n),n&&"string"==typeof n&&""!==n.trim()?(s=n.trim(),console.debug(`TimerCardEditor: Using '${ht}' for label: "${s}"`)):console.warn(`TimerCardEditor: Sensor '${e}' has no valid '${ht}' attribute. Falling back to entry ID based label: "${s}".`),t.has(o)?console.debug(`TimerCardEditor: Skipping duplicate entry_id: ${o}`):(t.set(o,{value:o,label:s}),console.debug(`TimerCardEditor: Added instance: ${s} (${o}) from sensor: ${e}`))}}const e=Array.from(t.values());return e.sort((t,e)=>t.label.localeCompare(e.label)),0===e.length&&console.info("TimerCardEditor: No Simple Timer integration instances found by scanning hass.states."),e}_getValidatedTimerButtons(t){if(Array.isArray(t)){const e=[],i=new Set;t.forEach(t=>{const o=String(t).trim().toLowerCase(),n=o.match(/^(\d+(?:\.\d+)?)\s*(s|sec|seconds|m|min|minutes|h|hr|hours|d|day|days)?(\*)?$/);if(n){const s=parseFloat(n[1]),r=n[1].includes("."),a=n[2]||"min",l=a.startsWith("h")||["h","hr","hours"].includes(a),d=a.startsWith("d")||["d","day","days"].includes(a);if(r&&!l&&!d)return;if(r&&(l||d)){const t=n[1].split(".")[1];if(t&&t.length>1)return}if(s>9999)return;if(["m","min","minutes"].includes(a)){if(s>0&&s<=9999){o.endsWith("*")?e.push(t):i.has(String(s))||(e.push(s),i.add(String(s)))}}else{o.endsWith("*")?e.push(t):i.has(o)||(e.push(t),i.add(o))}}});const o=e.filter(t=>"number"==typeof t),n=e.filter(t=>"string"==typeof t);return o.sort((t,e)=>t-e),n.sort(),[...o,...n]}return null==t?(console.log("TimerCardEditor: No timer_buttons in config, using empty array."),[]):(console.warn(`TimerCardEditor: Invalid timer_buttons type (${typeof t}):`,t,"- using empty array"),[])}async setConfig(t){const e=Object.assign({},this._config),i=this._getValidatedTimerButtons(t.timer_buttons),o={type:t.type||"custom:timer-card",timer_buttons:i,card_title:t.card_title||null,entity_state_icon:t.entity_state_icon||t.power_button_icon||null,slider_max:t.slider_max||120,slider_unit:t.slider_unit||"min",reverse_mode:t.reverse_mode||!1,hide_slider:t.hide_slider||!1,show_daily_usage:!1!==t.show_daily_usage,slider_thumb_color:t.slider_thumb_color||null,slider_background_color:t.slider_background_color||null,timer_button_font_color:t.timer_button_font_color||null,timer_button_background_color:t.timer_button_background_color||null,power_button_background_color:t.power_button_background_color||null,power_button_icon_color:t.power_button_icon_color||null,entity_state_button_background_color:t.entity_state_button_background_color||null,entity_state_button_icon_color:t.entity_state_button_icon_color||null,entity_state_button_background_color_on:t.entity_state_button_background_color_on||null,entity_state_button_icon_color_on:t.entity_state_button_icon_color_on||null,turn_off_on_cancel:!1!==t.turn_off_on_cancel,use_default_timer:t.use_default_timer||!1};t.timer_instance_id?o.timer_instance_id=t.timer_instance_id:console.info("TimerCardEditor: setConfig - no timer_instance_id in config, will remain unset"),t.entity&&(o.entity=t.entity),t.sensor_entity&&(o.sensor_entity=t.sensor_entity),this._config=o,this._configFullyLoaded=!0,JSON.stringify(e)!==JSON.stringify(this._config)?this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}})):console.log("TimerCardEditor: Config unchanged, not dispatching event"),this.requestUpdate()}connectedCallback(){super.connectedCallback(),this.hass?this._fetchTimerInstances():console.warn("TimerCardEditor: hass not available on connectedCallback. Deferring instance fetch.")}updated(t){var e;super.updated(t),t.has("hass")&&this.hass&&((null===(e=t.get("hass"))||void 0===e?void 0:e.states)===this.hass.states&&0!==this._timerInstancesOptions.length||this._fetchTimerInstances())}async _fetchTimerInstances(){var t,e;if(this.hass){this._timerInstancesOptions=await this._getSimpleTimerInstances();const i=await this._fetchLovelaceConfig(),o=this._findUsedTimerInstances(i);if(this._usedInstances=new Set(o),!this._configFullyLoaded)return void this.requestUpdate();if(null===(t=this._config)||void 0===t?void 0:t.timer_instance_id){const t=this._config.timer_instance_id,e=o.filter(e=>e===t).length;if(e>1){console.warn(`TimerCardEditor: Duplicate usage detected for '${t}' (count: ${e}). Auto-clearing.`);const i=Object.assign(Object.assign({},this._config),{timer_instance_id:null});this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}}if((null===(e=this._config)||void 0===e?void 0:e.timer_instance_id)&&this._timerInstancesOptions.length>0){if(!this._timerInstancesOptions.some(t=>t.value===this._config.timer_instance_id)){console.warn(`TimerCardEditor: Previously configured instance '${this._config.timer_instance_id}' no longer exists. User will need to select a new instance.`);const t=Object.assign(Object.assign({},this._config),{timer_instance_id:null});this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}}else console.info("TimerCardEditor: No timer_instance_id configured or no instances available. User must manually select.");this.requestUpdate()}}async _fetchLovelaceConfig(){if(!this.hass)return null;try{const t=this._getDashboardUrlPath();return await this.hass.callWS({type:"lovelace/config",url_path:t})}catch(t){return console.warn("TimerCardEditor: Failed to fetch lovelace config",t),null}}_getDashboardUrlPath(){const t=window.location.pathname.split("/");return t.length>1&&"lovelace"!==t[1]?t[1]:null}_findUsedTimerInstances(t){const e=[];if(!t)return e;const i=t=>{t&&"object"==typeof t&&("custom:timer-card"===t.type&&t.timer_instance_id&&e.push(t.timer_instance_id),["views","cards","sections","badges"].forEach(e=>{Array.isArray(t[e])&&t[e].forEach(i)}),t.card&&i(t.card))};return i(t),e}_handleNewTimerInput(t){const e=t.target;this._newTimerButtonValue=e.value}_addTimerButton(){var t;const e=this._newTimerButtonValue.trim();if(!e)return;const i=e.match(/^(\d+(?:\.\d+)?)\s*(s|sec|seconds|m|min|minutes|h|hr|hours|d|day|days)?(\*)?$/i);if(!i)return void alert("Invalid format! Use format like: 30, 30s, 10m, 1.5h, 1d. Add * for default timer (e.g. 30*)");const o=parseFloat(i[1]),n=i[1].includes("."),s=(i[2]||"min").toLowerCase(),r=!!i[3],a=s.startsWith("h"),l=s.startsWith("d");if(o>9999)return void alert("Value cannot exceed 9999");if(n&&!a&&!l)return void alert("Fractional values are only allowed for Hours (h) and Days (d)");if(n&&(a||l)){const t=i[1].split(".")[1];if(t&&t.length>1)return void alert("Maximum 1 decimal place allowed (e.g. 1.5)")}let d=o;if(s.startsWith("s")?d=o/60:s.startsWith("h")?d=60*o:s.startsWith("d")&&(d=1440*o),d<=0)return void alert("Timer duration must be greater than 0");let c=Array.isArray(null===(t=this._config)||void 0===t?void 0:t.timer_buttons)?[...this._config.timer_buttons]:[],h=e;if(i[2]||r||(h=o),c.includes(h))return this._newTimerButtonValue="",void this.requestUpdate();r&&(c=c.filter(t=>!String(t).includes("*"))),c.push(h);const u=c.filter(t=>"number"==typeof t),_=c.filter(t=>"string"==typeof t);u.sort((t,e)=>t-e),_.sort((t,e)=>t.localeCompare(e,void 0,{numeric:!0,sensitivity:"base"})),c=[...u,..._],this._updateConfig({timer_buttons:c}),this._newTimerButtonValue="",this.requestUpdate()}_removeTimerButton(t){var e;let i=Array.isArray(null===(e=this._config)||void 0===e?void 0:e.timer_buttons)?[...this._config.timer_buttons]:[];i=i.filter(e=>e!==t),this._updateConfig({timer_buttons:i})}_updateConfig(t){const e=Object.assign(Object.assign({},this._config),t);this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0})),this.requestUpdate()}render(){var t,e,i,o,n,s,r,a,l,d,c,h,u,_,p,g,m,f,v,b,y,$,x,w,S,C,T,k,E,A,P,M,I,U,V,L,D,O,B,N;if(!this.hass)return R``;const j=this._timerInstancesOptions||[],H=[{value:"",label:"None"}],z=null!==(t=this._tempSliderMaxValue)&&void 0!==t?t:String(null!==(e=this._config.slider_max)&&void 0!==e?e:120);j.length>0?H.push(...j):H.push({value:"none_found",label:"No Simple Timer Instances Found"});const W=this._getThemeColorHex("--secondary-background-color","#424242"),F=this._getThemeColorHex("--primary-text-color","#ffffff"),q=this._getThemeColorHex("--secondary-background-color","#424242"),J=this._getThemeColorHex("--secondary-background-color","#424242"),G=this._getThemeColorHex("--primary-color","#03a9f4"),K=this._getThemeColorHex("--ha-card-background",this._getThemeColorHex("--card-background-color","#1c1c1c")),X=this._getThemeColorHex("--secondary-text-color","#727272"),Y=this._getThemeColorHex("--ha-card-background",this._getThemeColorHex("--card-background-color","#1c1c1c")),Z=this._getThemeColorHex("--primary-color","#03a9f4");return R`
      <div class="card-config">
        ...
        <div class="config-row">
          <ha-select
            ...
            required
          >
            ${H.map(t=>{var e;const i=this._usedInstances.has(t.value),o=t.value===(null===(e=this._config)||void 0===e?void 0:e.timer_instance_id),n=i&&!o,s=t.label+(n?" (Already assigned)":"");return R`
              <mwc-list-item .value=${t.value} .disabled=${n}>
                ${s}
              </mwc-list-item>
            `})}
          </ha-select>
        ...
        <div class="config-row">
          <ha-textfield
            ...
            .value=${(null===(n=this._config)||void 0===n?void 0:n.entity_state_icon)||""}
        ...
        <div class="config-row">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <ha-select
              .label=${"Slider Unit"}
              .value=${(null===(r=this._config)||void 0===r?void 0:r.slider_unit)||"min"}
            ...
            <div class="config-row">
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===(a=this._config)||void 0===a?void 0:a.slider_thumb_color)||"#2ab69c"}
                  ...
                  <ha-textfield
                    ...
                    .value=${(null===(l=this._config)||void 0===l?void 0:l.slider_thumb_color)||""}
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===(d=this._config)||void 0===d?void 0:d.slider_background_color)||W}
            ...
            <div class="config-row">
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===(h=this._config)||void 0===h?void 0:h.timer_button_font_color)||F}
                  ...
                  <ha-textfield
                    ...
                    .value=${(null===(u=this._config)||void 0===u?void 0:u.timer_button_font_color)||""}
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===(_=this._config)||void 0===_?void 0:_.timer_button_background_color)||q}
                  ...
                  <ha-textfield
                    ...
                    .value=${(null===(p=this._config)||void 0===p?void 0:p.timer_button_background_color)||""}
            ...
            <div class="config-row">
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===(g=this._config)||void 0===g?void 0:g.power_button_background_color)||J}
                  ...
                  <ha-textfield
                    ...
                    .value=${(null===(m=this._config)||void 0===m?void 0:m.power_button_background_color)||""}
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===(f=this._config)||void 0===f?void 0:f.power_button_icon_color)||G}
            ...
            <div class="config-row">
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===(b=this._config)||void 0===b?void 0:b.entity_state_button_background_color)||K}
                  ...
                  <ha-textfield
                    ...
                    .value=${(null===(y=this._config)||void 0===y?void 0:y.entity_state_button_background_color)||""}
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===($=this._config)||void 0===$?void 0:$.entity_state_button_icon_color)||X}
                  ...
                  <ha-textfield
                    ...
                    .value=${(null===(x=this._config)||void 0===x?void 0:x.entity_state_button_icon_color)||""}
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===(w=this._config)||void 0===w?void 0:w.entity_state_button_background_color_on)||Y}
                  ...
                  <ha-textfield
                    ...
                    .value=${(null===(S=this._config)||void 0===S?void 0:S.entity_state_button_background_color_on)||""}
                ...
                <div style="display: flex; gap: 8px; align-items: center;">
                  <input
                    type="color"
                    value=${(null===(C=this._config)||void 0===C?void 0:C.entity_state_button_icon_color_on)||Z}
                  ...
                  <ha-textfield
                    ...
                    .value=${(null===(T=this._config)||void 0===T?void 0:T.entity_state_button_icon_color_on)||""}
        ...
        <div class="config-row">
          <ha-formfield .label=${(null===(E=this._config)||void 0===E?void 0:E.reverse_mode)?"Use Default Timer (Disabled in Reverse Mode)":"Use Default Timer (auto-start when entity turns on)"}
                        title=${(null===(A=this._config)||void 0===A?void 0:A.reverse_mode)?"Default Timer cannot be used with Reverse Mode (Delayed Start)":""}>
            <ha-switch
              .checked=${!!(null===(P=this._config)||void 0===P?void 0:P.use_default_timer)&&!(null===(M=this._config)||void 0===M?void 0:M.reverse_mode)}
              .disabled=${(null===(I=this._config)||void 0===I?void 0:I.reverse_mode)||!1}
        ...
        <div class="config-row">
          <ha-formfield .label=${"Reverse Mode (Delayed Start)"}>
            <ha-switch
              .checked=${(null===(U=this._config)||void 0===U?void 0:U.reverse_mode)||!1}
        ...
        <div class="config-row">
          <ha-formfield .label=${"Hide Timer Slider"}>
            <ha-switch
              .checked=${(null===(V=this._config)||void 0===V?void 0:V.hide_slider)||!1}
        ...
        <div class="config-row">
          <ha-formfield .label=${"Show Daily Usage"}>
            <ha-switch
              .checked=${!1!==(null===(L=this._config)||void 0===L?void 0:L.show_daily_usage)}
        ...
        <div class="config-row">
            <div class="timer-chips-container">
             ...
             <div class="chips-wrapper">
                ${((null===(D=this._config)||void 0===D?void 0:D.timer_buttons)||ut).map(t=>{const e=String(t).endsWith("*"),i=String(t).replace("*","");return R`
                    <div class="${e?"timer-chip default-timer":"timer-chip"}" style="${e?"border: 1px solid var(--primary-color); background-color: rgba(var(--rgb-primary-color), 0.1);":""}">
                        <span>${"number"==typeof t?t+"m":i}${e?" (Default)":""}</span>
