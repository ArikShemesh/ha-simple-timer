      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          `}
           ...
           <!-- Timer Buttons Grid -->
           ${this.buttons.length>0||(null===(d=this._config)||void 0===d?void 0:d.hide_slider)&&v?j`
          <div class="button-grid">
            ${this.buttons.map(t=>{if(t.isDefault)return"";const e=v&&Math.abs(b-t.minutesEquivalent)<.001&&"button"===m.attributes.timer_start_method;return j`
        ...
        <div class="config-row">
            <div class="timer-chips-container">
             ...
             <div class="chips-wrapper">
                ${((null===(T=this._config)||void 0===T?void 0:T.timer_buttons)||_t).map(t=>{const e=String(t).replace("*","");return j`
