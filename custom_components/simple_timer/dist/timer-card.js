      ...
      <ha-card>
        ...
        ${y.isOrphaned?V`
          <div class="status-message warning">
            ...
            <span class="status-text">
              Active ${y.duration}-minute timer has no corresponding button. 
        ...
        <div class="card-content">
          ...
          <div class="countdown-section">
            <div class="countdown-display ${u?"active":""} ${g?"reverse":""}">
              ${v}
            </div>
						${!1!==(null===(s=this._config)||void 0===s?void 0:s.show_daily_usage)?V`
          ...
          <div class="slider-row">
            <div class="slider-container">
              <input
                ...
                min="0"
								step="1"
                max="${(null===(n=this._config)||void 0===n?void 0:n.slider_max)||120}"
            ...
            <div class="power-button-small ${u&&g?"on reverse":h?"on":(null===(r=this._config)||void 0===r?void 0:r.reverse_mode)?"reverse":""}" 
								 @click=${this._handlePowerClick}
								 title="Click to toggle power">
							${(null===(o=this._config)||void 0===o?void 0:o.power_button_icon)?V`<ha-icon icon="${this._config.power_button_icon}"></ha-icon>`:""}
						</div>
          </div>

          <!-- Timer Buttons -->
          <div class="button-grid">
            ${this.buttons.map(t=>{const e=u&&_===t&&"button"===d.attributes.timer_start_method,i=p||u&&!e;return V`
            ...
            `)}
				...
				<div class="config-row">
					<ha-formfield .label=${"Show Daily Usage"}>
						<ha-switch
							.checked=${!1!==(null===(a=this._config)||void 0===a?void 0:a.show_daily_usage)} // Default to true
