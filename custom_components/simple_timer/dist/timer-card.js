      ...
      <ha-card>
        ...
        ${$.isOrphaned?j`
          <div class="status-message warning">
            ...
            <span class="status-text">
              Active ${$.duration}-minute timer has no corresponding button. 
        ...
        <div class="card-content">
          ...
          <div class="countdown-section">
            <div class="countdown-display ${_?"active":""} ${m?"reverse":""}">
              ${v}
            </div>
						${!1!==(null===(n=this._config)||void 0===n?void 0:n.show_daily_usage)?j`
          ...
          <div class="slider-row">
            ...
            <div class="power-button-small ${_&&m?"on reverse":u?"on":(null===(r=this._config)||void 0===r?void 0:r.reverse_mode)?"reverse":""}" 
								 @click=${this._handlePowerClick}
								 title="Click to toggle power">
							${(null===(a=this._config)||void 0===a?void 0:a.power_button_icon)?j`<ha-icon icon="${this._config.power_button_icon}"></ha-icon>`:""}
						</div>
          </div>

          <!-- Timer Buttons -->
          <div class="button-grid">
            ${this.buttons.map(t=>{const e=_&&g===t&&"button"===h.attributes.timer_start_method,i=p||_&&!e;return j`
      ...
      <div class="card-config">
        ...
        <div class="config-row">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(l=this._config)||void 0===l?void 0:l.slider_background_color)||C}
        ...
        <div class="config-row">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(d=this._config)||void 0===d?void 0:d.timer_button_font_color)||E}
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(u=this._config)||void 0===u?void 0:u.timer_button_background_color)||k}
        ...
        <div class="config-row">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(g=this._config)||void 0===g?void 0:g.power_button_background_color)||T}
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              <input
                type="color"
                value=${(null===(m=this._config)||void 0===m?void 0:m.power_button_icon_color)||A}
        ...
        <div class="config-row">
          <ha-formfield .label=${"Show Daily Usage"}>
            <ha-switch
              .checked=${!1!==(null===(v=this._config)||void 0===v?void 0:v.show_daily_usage)}
