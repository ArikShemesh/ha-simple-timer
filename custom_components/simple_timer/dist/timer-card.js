      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          <div class="countdown-section">
            <div class="countdown-display ${l?"active":""}">
              ${p}
            </div>
          </div>
          ...
          <div class="slider-row">
            ...
            <div class="power-button-small ${c?"on":""}" 
							...
							${(null===(s=this._config)||void 0===s?void 0:s.power_button_icon)?V`<ha-icon icon="${this._config.power_button_icon}"></ha-icon>`:""}
							<div class="power-usage-text">${_.replace("Daily Usage: ","")}</div>
						</div>
          </div>

          <!-- Timer Buttons -->
          <div class="button-grid">
            ${this.buttons.map(t=>{const e=l&&d===t&&!this._timerStartedViaSlider,i=h||l&&!e;return V`
