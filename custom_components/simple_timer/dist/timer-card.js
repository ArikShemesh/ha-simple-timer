        ...
        ${w.isOrphaned?V`
          <div class="status-message warning">
            ...
            <span class="status-text">
              Active ${w.duration}-minute timer has no corresponding button. 
          ...
          <div class="countdown-section">
            <div class="countdown-display ${_?"active":""} ${m?"reverse":""}">
              ${b}
						...
						${!1!==(null===(n=this._config)||void 0===n?void 0:n.show_daily_usage)?V`
          ...
          <div class="slider-row">
            <div class="slider-container">
              <input
                ...
                min="0"
								step="1"
                max="${(null===(o=this._config)||void 0===o?void 0:o.slider_max)||120}"
            ...
            <div class="power-button-small ${_&&m?"on reverse":u?"on":(null===(r=this._config)||void 0===r?void 0:r.reverse_mode)?"reverse":""}" 
							...
							${(null===(a=this._config)||void 0===a?void 0:a.power_button_icon)?V`<ha-icon icon="${this._config.power_button_icon}"></ha-icon>`:""}
						</div>
          </div>

          <!-- Timer Buttons -->
          <div class="button-grid">
            ${this.buttons.map(t=>{const e=_&&p===t&&"button"===h.attributes.timer_start_method,i=g||_&&!e;return V`
