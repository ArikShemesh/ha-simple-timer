      ...
      <ha-card>
        ...
        <div class="main-grid">
          ...
          <div class="button readonly" @click=${this._showMoreInfo}>
            <span class="daily-time-text ${p?"with-seconds":""}">${h}</span>
            <span class="runtime-label">${u}</span>
          </div>
        </div>
        <div class="button-grid">
          ${this.buttons.map(t=>{const e=c&&l===t,i=d||c&&!e;return D`
